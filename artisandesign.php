...
const arrn1 = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Artisan_Design</p>
...
if(document.getElementById("lbResultadoo").innerHTML== "bamboo") {
const total=116;
...
if(document.getElementById("lbResultadoo").innerHTML== "bambooydot") {
const total=145;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
...
if(document.getElementById("lbResultadoo").innerHTML== "disco") {
const total=760;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
}
if(document.getElementById("lbResultadoo").innerHTML== "geopicket") {
const total=20;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
...
if(document.getElementById("lbResultadoo").innerHTML== "geostar") {
const total=16;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
...
if(document.getElementById("lbResultadoo").innerHTML== "leaves") {
const total=894;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
}
if(document.getElementById("lbResultadoo").innerHTML=="ostra") {
const total=84;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
...
if(document.getElementById("lbResultadoo").innerHTML== "sigma") {
const total=132;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "stella") {
const total=185;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
