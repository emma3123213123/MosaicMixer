...
const arr = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Group1_Design</p>
...
const changeColor = (event) => {
  ...
  if(arr.length == 4)
{
alert("solo tienes 3 colores, asegurate de colorear todos los materiales y usa el boton de reset")
...
///////////////////////////////validar materiales totales////////////////////////
   
if(document.getElementById("lbResultadoo").innerHTML== "24mosaic")
    {
      const total=15;
     ...
     if(document.getElementById("lbResultadoo").innerHTML == "2x2mosaic") {              
   const total=36;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
     ...
     if(document.getElementById("lbResultadoo").innerHTML== "hexagonmosaic") {       
       const total=56;
       if(contador1+contador2+contador3 > total-1)          {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "fiddlestickmosaic") {  
   const total=36;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "78mosaic") {
 const total=144;
 if(contador1+contador2+contador3 > total-1)          {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "brickbondlarge") {  
   const total=8;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "herringbonelarge") { 
   const total=16;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "1x6interlocking") {
   const total=24;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "versailles") {
   const total=12;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "rhomboidmosaic") {
   const total=121;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "riverrock") {
   const total=74;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
...
if(document.getElementById("lbResultadoo").innerHTML== "78rockface") {
const total=196;
if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "minibrickbond") {
     const total=91;
     if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "smallherringbone") {
   const total=80;
   if(contador1+contador2+contador3 > total-1)         {
      document.getElementById("saco").hidden = false;
     }
   ...
   if(document.getElementById("lbResultadoo").innerHTML== "78hex") {
     const total=175;
     if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
