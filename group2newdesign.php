...
const arrn1 = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Group2_Design</p>
...
if(document.getElementById("lbResultadoo").innerHTML== "12mosaic") {
const total=484;
...
if(document.getElementById("lbResultadoo").innerHTML== "octagonydotmosaic") {
const total=64;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "basketweavemosaic") {
const total=113;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "stripemosaic") {
const total=224;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "targetmosaic") {
const total=125;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "byzantinesmall") {
const total=289;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
}else
if(document.getElementById("lbResultadoo").innerHTML== "byzantinelarge") {
const total=156;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
