...
const arrn1 = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Group3_Design</p>
...
if(document.getElementById("lbResultadoo").innerHTML== "rockfacesmall") {
const total=20;
...
if(document.getElementById("lbResultadoo").innerHTML== "rockfacelarge") {
const total=42;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "trapezoid") {
const total=192;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "geosquare") {
const total=80;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "rombus") {
const total=216;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
...
if(document.getElementById("lbResultadoo").innerHTML== "chevronxs") {
const total=160;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
}else
if(document.getElementById("lbResultadoo").innerHTML== "cubo") {
const total=432;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
