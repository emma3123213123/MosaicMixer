        ...
        <div class="collapse navbar-collapse me-auto" id="navbarCollapse">
            ...
            <ul class="navbar-nav border-lg-start mb-1 mb-lg-0">
                ...
                <li class="nav-item me-1">
                  ...
                  <li class="nav-item me-1">
                    <a style="color: #4285f4;" class="nav-link" href="/MosaicMixer/mcgahanuevodesign.php">Design_Mosaic</a>
                </li>
                <li class="nav-item me-1">
...
<!-- End of Navbar -->
  ...
  <p style= "color: #462ae2; font-size: 18pt; text-align: center; font-family:courier;">Mcgaha</p>
...
if(name+".gltf" == "vernazzasmall.gltf") {
sequence1 = [1,2,5,6];
const total=8;
...
if(name+".gltf" == "vernazzalarge.gltf") {
sequence1 = [1,3];
const total=4;
document.getElementById('color111').innerHTML = (total);
document.getElementById("color111a").value = (total);
