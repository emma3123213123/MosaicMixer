...
const arr = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Parquet_Design</p>
...
if(document.getElementById("lbResultadoo").innerHTML== "pt001") {
const total=39;
...
if(document.getElementById("lbResultadoo").innerHTML== "pt002") {
const total=20;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "pt003") {
const total=16;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     } 
