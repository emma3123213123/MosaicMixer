...
const arrn1 = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Pebbles_Desgn</p>
...
if(document.getElementById("lbResultadoo").innerHTML== "straight") {
const total=24;
...
if(document.getElementById("lbResultadoo").innerHTML== "diagonal") {
const total=34;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "argyle") {
const total=5;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "bussola") {
const total=41;
document.getElementById('color111').innerHTML = (total);
document.getElementById("color111a").value = (total);
}
else
if(document.getElementById("lbResultadoo").innerHTML== "circulo") {
const total=10;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "clovers") {
const total=2;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "lattice") {
const total=9;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "petals") {
const total=5;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "petunias") {
const total=28;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "stargazer") {
const total=4;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
