...
const arrn1 = [];
  ...
  <p style= "color: #462ae2; font-size: 18pt;text-align: center; font-family:courier;">Specialty_Design</p>
...
$consulta = "SELECT colors.Color,colors.clavecolor FROM price,colors,models where models.clavemodel='madisonjosephine' and colors.idcolor = price.idcolor and models.idmodel = price.idmodel ORDER BY colors.color ASC ";
...
if(document.getElementById("lbResultadoo").innerHTML== "madisondewey") {
const total=30;
...
if(document.getElementById("lbResultadoo").innerHTML== "southtowncypress") {
const total=60;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "calico") {
const total=12;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
...
if(document.getElementById("lbResultadoo").innerHTML== "galileo") {
const total=7;
if(contador1+contador2+contador3 > total-1)        {
      document.getElementById("saco").hidden = false;
     }  
